...
int main(int argc, char **argv) {
  ...
  // practice) be 1 plus the number of arguments, as virtually all
  ...
  // We can easily multiply a matrix with a vector (but actually still matices
  // and matrices)
  v_3d << 3, 2, 1;
  vd_3d << 4, 5, 6;

  // In Eigen you can't mix two different types of matrices, like this is
  // wrong Matrix<double, 3 , 2> result_wrong_type = matrix23 * v_3d;
  ...
  // (double)SOMETHING cast SOMETHING to double
